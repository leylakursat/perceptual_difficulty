function make_slides(f) {
  ...
  slides.practicetrial = slide({
    ...
    present:
      [{
        'targetName': 'box_cardboard_blue',
        'competitorName': 'box_wood_blue',
        'notCompetitorName': 'box_wood_brown',
      ...
      {
        'targetName': 'ball_metal_green',
        'competitorName': 'ball_metal_red',
        'notCompetitorName': 'ball_plastic_red',
      ...
      {
        'targetName': 'bowl_glass_green',
        'competitorName': 'bowl_glass_blue',
        'notCompetitorName': 'bowl_metal_blue',
        'condition': 'material_correct',
        'featureQuestion': 'material',
        'adjQuestion': 'metal',
        'numQuestion': '2',
        'correctAnsQuestion': 'yes',
        'contextID': 'practice_3',
      },
      {
        'targetName': 'vase_wood_green',
        'competitorName': 'vase_glass_green',
        'notCompetitorName': 'vase_glass_blue',
        'condition': 'color_incorrect',
        'featureQuestion': 'color',
        'adjQuestion': 'blue',
        'numQuestion': '3',
        'correctAnsQuestion': 'no',
        'contextID': 'practice_4',
      },
      {
        'targetName': 'bag_paper_blue',
        'competitorName': 'bag_plastic_blue',
        'notCompetitorName': 'bag_plastic_green',
        'condition': 'color_incorrect',
        'featureQuestion': 'color',
        'adjQuestion': 'green',
        'numQuestion': '4',
        'correctAnsQuestion': 'no',
        'contextID': 'practice_5',
      },
      {
        'targetName': 'door_wood_yellow',
        'competitorName': 'door_steel_yellow',
        'notCompetitorName': 'door_steel_red',
        'condition': 'material_correct',
        'featureQuestion': 'material',
        'adjQuestion': 'wooden',
        'numQuestion': '1',
        'correctAnsQuestion': 'yes',
        'contextID': 'practice_6',
      },
...
function init() {
  ...
  function preloadImages() {
    for (pos in exp.all_stims) {
      (new Image()).src = "images/" + exp.all_stims[pos].contextID + "_1.png";
      (new Image()).src = "images/" + exp.all_stims[pos].contextID + "_2.png";
    };
  ...
  exp.structure = ["bot", "i0", "instructions", "practicetrial", "beforeobject", "objecttrial", 'subj_info', 'thanks'];
