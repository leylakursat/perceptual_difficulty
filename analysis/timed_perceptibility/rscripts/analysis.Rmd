...
**By unique item - Proportion of correct responses to matching features** (plot in graphs/)
...
ggsave(file="../graphs/by_image_proportion_matching.pdf",width=14,height=20)
